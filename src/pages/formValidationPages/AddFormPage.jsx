...
const AddFormPage = () => {
    ...
    return (
        <div className="p-4 max-w-4xl mx-auto">
            <h1 className="text-2xl font-semibold mb-4">Add New Form Validation</h1>
            <form onSubmit={handleSubmit} className="space-y-4">

                <div className="flex flex-col mb-4">
                    <label htmlFor="url" className="text-lg font-medium mb-2">URL</label>
                    <input
                        type="text"
                        id="url"
                        name="url"
                    ...
                    {formData.configurations.map((config, index) => (
                        <div key={index} className="border border-gray-300 p-4 rounded mb-4">
                            <div className="flex flex-col mb-2">
                                <label htmlFor={`fieldName-${index}`} className="text-lg font-medium mb-2">Field Name</label>
                                <input
                                    type="text"
                                    id={`fieldName-${index}`}
                                    name="fieldName"
                            ...
                            <div className="flex flex-col mb-2">
                                <label htmlFor={`fieldLabel-${index}`} className="text-lg font-medium mb-2">Field Label</label>
                                <input
                                    type="text"
                                    id={`fieldLabel-${index}`}
                                    name="fieldLabel"
                            ...
                            <div className="flex flex-col mb-2">
                                <label htmlFor={`type-${index}`} className="text-lg font-medium mb-2">Type</label>
                                <select
                                    id={`type-${index}`}
                                    name="type"
                                    value={config.type}
                            ...
                            <div className="flex flex-col mb-2">
                                <label htmlFor={`regex-${index}`} className="text-lg font-medium mb-2">Regex</label>
                                <input
                                    type="text"
                                    id={`regex-${index}`}
                                    name="regex"
                            ...
                            <div className="flex flex-col mb-2">
                                <label htmlFor={`maxLength-${index}`} className="text-lg font-medium mb-2">Max Length</label>
                                <input
                                    type="number"
                                    id={`maxLength-${index}`}
                                    name="maxLength"
